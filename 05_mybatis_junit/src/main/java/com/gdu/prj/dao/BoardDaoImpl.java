...
public class BoardDaoImpl implements BoardDao {
  ...
  public List<BoardDto> selectBoardList(Map<String, Object> params) {
    ...
    List<BoardDto> boardList = sqlSession.selectList("com.gdu.prj.dto.BoardDto.board.selectBoardList", params);
    sqlSession.close();
    return boardList;
  }
  ...
  public BoardDto selectBoardByNo(int board_no) {
    SqlSession sqlSession = factory.openSession();
    BoardDto board = sqlSession.selectOne("com.gdu.prj.dao.selectBoardByNo", board_no);
    sqlSession.close();
    return board;
  }
