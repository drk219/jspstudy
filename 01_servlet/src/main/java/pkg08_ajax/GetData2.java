...
public class GetData2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  // 도로교통공단 사망교통사고정보서비스
	  StringBuilder urlBuilder = new StringBuilder("http://pis.data.go.kr/B552061/AccidentDeath/getRestTrafficAccidentDeath");
	  urlBuilder.append("?serviceKey=").append(URLEncoder.encode("Xm6WqUCukncriVBzZ5j42xoHtWsx3J/b+yCPov98WkghwsFdXP8fDyj/GIZJqfxyoEy3rMJX9MeHdDuiV3tDiA==", "UTF-8"));
