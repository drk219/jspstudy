...
<body>
  ...
  <div>
    <a href="${contextPath}/board/list.brd?page=1&sort=DESC&display=${display}">최신순</a>
    <span>|</span>
    <a href="${contextPath}/board/list.brd?page=1&sort=ASC&display=${display}">오래된순</a>
  </div>
